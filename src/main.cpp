...
int main()
{
    ...
    Shader lightShader("D:\\opengl\\code\\RayCode\\02_Hello_Material\\src\\shader\\lightvertex.glsl", "D:\\opengl\\code\\RayCode\\02_Hello_Material\\src\\shader\\lightfragment.glsl");
    Shader cubeShader("D:\\opengl\\code\\RayCode\\02_Hello_Material\\src\\shader\\cubevertex.glsl", "D:\\opengl\\code\\RayCode\\02_Hello_Material\\src\\shader\\cubefragement.glsl");
    //@定义顶点数组，添加颜色
    float vertices1[] = {
...
一个是管理顶点信息*/
    ...
    */
    ...
    glVertexAttribPointer(0 /*硬代码的location决定，相当于target*/, 3 /*顶点属性是一个vector几的量*/, GL_FLOAT /*float类型*/, GL_FALSE /*不被标准化*/, 6 * sizeof(float) /*步长*/, (void *)0);
    ...
    */
    ...
    while (!glfwWindowShouldClose(window)) //检查用户是否需要退出
    {
        ...
        cubeShader.use();
        //光照位置
        cubeShader.setVec3("objCol", 1.0f, 0.5f, 0.31f);
        cubeShader.setVec3("lightCol", 1.0f, 1.0f, 1.0f);
        cubeShader.setVec3("lightPos", lightPos);
        cubeShader.setVec3("viewPos", camera.Position);
        cubeShader.setVec3("material.Enveriment", 1.0f, 0.5f, 0.31f);
        cubeShader.setVec3("material.Diffuse", 1.0f, 0.5f, 0.31f);
        cubeShader.setVec3("material.Specular", 0.5f, 0.5f, 0.5f);
        cubeShader.setFloat("material.shininess", 32.0f); //材质反光系数
        ...
        cubeShader.setVec3("light.EnverimentK", ambientColor);
        cubeShader.setVec3("light.diffuseK", diffuseColor);
        cubeShader.setVec3("light.specularK", 1.0f, 1.0f, 1.0f); //光照强度系数
